...
- **Malware binaries were not retained.** Only the log directory was exported at teardown. Hashes survive; the samples do not. No static analysis was performed and none is claimed. Family attribution in the report is based on naming convention and public analysis of identically named samples, not on hash verification of these specific binaries.
